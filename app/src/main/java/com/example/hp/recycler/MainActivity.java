...
*/
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                prepareMovieData(product_id,product_name);
            }
        });
    ...
    private void prepareMovieData(String product_id,String product_name) {


        Data movie = new Data(product_id,product_name);
        movieList.add(movie);
